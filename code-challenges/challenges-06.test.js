...
Write a function named getCourseKeys that takes in the courseInfo charactersect and returns an array containing the keys for the courseInfo charactersect.
...
Write a function named hasChildrenValues that uses charactersect.values to determine if any given character in the data set has children.
...
Write a function named houseSize that takes in the array of characters and creates an charactersect for each house containing the name of the house and the number of members.

All of these charactersects should be added to an array named "sizes". Return the "sizes" array from the function.
...
This function should create an charactersect for each house containing the name of the house and the number of members. If the spouse is deceased, do not include him/her in the total number of family members.

All of these charactersects should be added to an array named "survivors". Return the "survivors" array from the function.
...
xdescribe('Testing challenge 7', () => {
  test('It should return an charactersect for each house containing the name and size', () => {
